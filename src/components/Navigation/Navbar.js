...
export default class Navbar extends React.Component {
    ...
    async forgotEmail(e) {
        ...
        const response = await fetch('https://staging-webservice.supportgenie.io/v3/agent/reset-password', {
            method: 'post',
        ...
        if (json.success == true) {
            this.setState({ emailSent: 'Instructions to reset password has been sent your email address' });
        } else {
    ...
    async postLoginData(data) {
        ...
        const response = await fetch('https://staging-webservice.supportgenie.io/v3/company/validate/primaryAgent', {
            method: 'post',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data),
        });
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <Link
                                                    ...
                                                    style={{ color: 'black', display: 'block', margin: '6px' }}
                                    ...
                                    {loggedIn == '' ? (
                                        <ul className="dropdown-menu">
                                            <form className="navbar-form" role="signup" formGroup="signInForm">
                                                ...
                                                <label className="login-header">Log in to your account:</label>
                                                ...
                                                <button className="btn sign-in-button" onClick={this.handleSignIn}>
                                                    Sign In
                                                </button>
                                                <a
